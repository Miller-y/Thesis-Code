...
# 1. 设置文件路径
input_file = 'data/csi_data_104.xlsx'  # 请修改为您实际的文件名
output_file = 'data/csi_data_104_original.xlsx'
...
# 尾部3对: 125-127
REMOVE_INDICES = {0, 1, 2, 3, 61, 62, 63, 64, 65, 66, 67, 125, 126, 127}
...
try:
    ...
    if (original_len - cleaned_len)//2 == 14:
        print("验证通过：成功剔除了 14 对无效数据。")
    else:
        print("警告：剔除的数量与预期不符！")
except:
    print("验证步骤跳过（数据可能为空）。")
